...
<div class="app-title">
    <div>
        <h1><i class="fa fa-commenting" aria-hidden="true"></i> Comment</h1>
        <p>Start a beautiful journey here</p>
    </div>
    <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><a href="#"><i class="fa fa-home fa-lg"></i></a></li>
        <li class="breadcrumb-item"><a href="{{ route('comment.index') }}">ข้อมูลรายการ</a></li>
        <li class="breadcrumb-item">แก้ไขรายการ</li>
    </ul>
</div>
<div class="row">
    <div class="col-md-12">
        <form method="POST" action="{{ route('comment.update', $result->id) }}">
            @csrf
            {{ method_field('PUT') }}
            <div class="tile">
                <div class="tile-title-w-btn">
                    <h3 class="title">แก้ไขรายการ Comment #{{ $result->id }}</h3>
                </div>
                <div class="tile-body">
